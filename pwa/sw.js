...
//
// It caches nothing, deliberately. The ledger is a live view of a database on
// the server, and a cache-first worker would hand back a run you have since
// moved past, off the phone's disk, with no way to tell that is what happened.
// A stale answer about what you have ticked is worse than no answer, so every
// request goes to the network exactly as it would in a tab.
//
...
<style>
  html{background:#15150F;color:#E9E5D6;font:16px/1.5 system-ui,sans-serif}
  body{display:grid;place-content:center;gap:20px;min-height:100vh;margin:0;
       padding:24px;text-align:center}
  h1{font-size:19px;font-weight:600;margin:0}
  p{margin:0;color:#87857A;max-width:30ch}
  button{background:#D2B34F;color:#15150F;border:0;border-radius:8px;
         padding:11px 22px;font:inherit;font-weight:600}
</style></head><body>
<h1>Can't reach the ledger</h1>
<p>The server is unreachable. Your progress is on it, not here.</p>
